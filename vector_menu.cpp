...
//recibe el grupo, y con un lambda lo ordena desde el primero al ultimo comparando alumno a con b y retorna la comparacion
    void ordenarporPromedioDesc(vector<Alumno>& grupo) {
...
//recibe el grupo, y con un lambda lo ordena desde el primero al ultimo comparando alumno a con b y retorna la comparacion
    void ordenarporPromedioAsc(vector<Alumno>& grupo) {
        sort(grupo.begin(), grupo.end(), [](const Alumno& a, const Alumno& b) {
            return a.promedio > b.promedio;
        });
        mostrarAlumnos(grupo);
...
int main () {
    ...
    if (opcion == 1){
        ...
        ordenarporPromedioDesc(grupo);
        cout << endl;
    }else if (opcion == 7) {
        cout << "Promedios en forma ascendente" << endl;
       ordenarporPromedioAsc(grupo);
        cout << endl;
    }else if (opcion == 8) {
        ...
        ordenarporPromedioAsc(grupo);
        cout << "Mejor alumno: " << grupo[0].nombre << " " << grupo.front().promedio << endl;
    }else if (opcion == 0) {
        cout << "Saliendo..." << endl;
    }
